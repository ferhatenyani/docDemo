...
export function Toaster() {
  ...
  return (
    <div
      className="fixed z-[200] bottom-4 right-4 left-4 sm:end-6 sm:start-auto sm:bottom-6 flex flex-col gap-2 pointer-events-none"
      aria-live="polite"
    >
      {toasts.map((t) => {
        ...
        return (
          ...
          >
            ...
            <button
              ...
              aria-label={tt("close")}
              className="h-6 w-6 rounded-md grid place-items-center text-ink-400 hover:bg-ink-100 hover:text-ink-700 cursor-pointer -me-1 -mt-0.5"
            >
